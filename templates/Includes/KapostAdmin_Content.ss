    ...
    <div class="cms-content-header north">
        ...
        <div class="cms-content-header-tabs cms-tabset-nav-primary ss-ui-tabs-nav">
            <ul>
                ...
                <li class="tab-KapostBridgeLogViewer link">
                    <a href="admin/kapost-bridge-logs/" class="cms-panel-link" title="Form_EditForm"><%t KapostBridgeLogViewer.MENUTITLE "_Kapost Bridge Logs" %></a>
                </li>
            </ul>
        </div>
    </div>
